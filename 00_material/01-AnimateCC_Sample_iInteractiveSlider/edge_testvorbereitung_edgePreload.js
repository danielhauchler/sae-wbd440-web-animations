...
if(document.addEventListener ){ 
   ...
   aLoader = [
    ...
    { load: "edge_includes/edge.2.0.1.min.js"},
          { load: "edge_testvorbereitung_edge.js"},
          { load: "edge_testvorbereitung_edgeActions.js"}];
...
preContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['-2px','1px','958px','365px','auto','auto'],
   ...
   },
   {
      ...
      type:'image',
      tag:'img',
      rect:['369px','209px','220px','19px','auto','auto'],
      fill:["rgba(0,0,0,0)",'images/loader-bar.gif','0px','0px']
   },
   {
      id:'Text4',
      type:'text',
      rect:['405px','158px','172px','50px','auto','auto'],
      text:"loading...",
      align:"left",
      font:['Verdana, Geneva, sans-serif',33,"rgba(228,228,228,1)","normal","none","normal"]
   }]};//simpleContent
